...
<nav class="navbar navbar-expand-lg sticky-top"id="navbarPropio">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="nav-link" href="quienessomos.php">Sobre Nosotros</a>
        ...
        <form class="form-inline my-2 my-lg-0">
            <input type="search" class="form-control" placeholder="Buscar" aria-label="Search" name="buscador" id="buscador" required>
        </form>
    </div>
</nav>