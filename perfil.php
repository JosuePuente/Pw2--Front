                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="container2">
                            <div class="row" style="padding-top: 20px;">
                                <div class="col-3">
                                    <div id="imagen">
                                        <img class="img-profile" id="elAvatar" src="<?php echo $avatar ?>">
                                    </div>
                                    <div class="file btn btn-primary" id="btnAvatar">
                                        <input type="file" name="avatar" id="avatar" hidden="true"/>
                                        <label class="btn btn-outline-secondary button-edit" for="avatar">Cambiar Foto</label>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="row" style="padding-top: 20px; padding-bottom: 10px;">
                                        <div class="col-lg-5">
                                            <h2 class="username"><?php echo $nombreUsuario ?></h2>
                                        </div>
                                        <div class="col-lg-6" data-toggle="modal" data-target="#editarPerfil">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <p class="profile-datas">Te uniste el <?php echo $fechaAlta ?>.</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h1 class="name">Soy</h1>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <p class="profile-desc"><?php if ($tipo) echo "Escuela";
                                                                    else echo "Estudiante"; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-2"></div>
