...
<body>
    ...
    $direccion = dirname(__FILE__);
    require_once $direccion . "/php/editarCurso/getCurso.php";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <form id="frmCurso" method="POST" autocomplete="off" onsubmit="return editarCurso()">

                    <input type="text" id="idCurso" name="idCurso" hidden="" value="<?php echo $idCurso; ?>">

                    <div class="filter dropdown filteEdit">
                    ...
                    <br>
                    <label>Título </label>
                    <input type="text" id="titulo" name="titulo" class="form-control" placeholder="Título del curso" value="<?php echo $datos[0]["titulo"]; ?>">
                    <label>Descripción </label>
                    <textarea id="descripcion" name="descripcion" class="form-control" rows="5" placeholder="Descripción del curso"><?php echo $datos[0]["descripcion"]; ?></textarea>
                    <label>Costo del curso </label>
                    <input type="number" id="costo" name="costo" value="<?php echo $datos[0]["costo"]; ?>" step=".01">
                    <small>Para indicar que tu curso es gratis, ingrese 0</small>

                    <div class="row btns">
                        <div class="col-sm-6 text-left">
                            <label class="btn btn-outline-secondary btnAvatar" for="imagen">Cambiar Imagen</label>
                        ...
                        <div class="col-sm-6 text-right">
                            <input type="submit" value="Editar curso" class="btnSubmit">
                        </div>
                    </div>
