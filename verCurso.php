...
<body>
    ...
    <div class="container">
        <div class="row arriba">
            ...
            <div class="col-lg-9">
                <div class="pl-lg ">
                    <h1 class="titulo" align=center><?php  echo $datos[0]["titulo"]; ?></h1>
                    <p align=right class="autor">Creado por <?php echo $datos[0]["apellidoP"] . " " . $datos[0]["apellidoM"] . " " . $datos[0]["nombre"]; ?> el <?php echo $datos[0]["fechaCreacion"]; ?></p>
                    <div class="info">
                        <p>Categoría(s): <?php
